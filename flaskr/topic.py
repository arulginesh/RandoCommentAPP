...
def index():
    ...
    return render_template("topic/index.html", allcomments=allcomments)
...
def comments():
    ...
    if request.method == "POST":
        ...
        if error is not None:
            ...
            db.commit()
            return redirect(url_for("topic.comments"))
    allcomments = get_comments()        
    return render_template("topic/create.html", allcomments=allcomments)
